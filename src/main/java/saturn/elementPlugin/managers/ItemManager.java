...
import saturn.elementPlugin.items.api.ElementItem;
...
public class ItemManager {
    ...
    public ItemStack createUpgrader1() {
        return saturn.elementPlugin.items.impl.Upgrader1Item.make(plugin);
    }
    ...
    public ItemStack createUpgrader2() {
        return saturn.elementPlugin.items.impl.Upgrader2Item.make(plugin);
    }
}