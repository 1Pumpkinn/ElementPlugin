...
public abstract class BaseElement implements Element {
     ...
     */
    protected boolean hasMana(Player player, saturn.elementPlugin.managers.ManaManager mana, int cost) {
     ...
     */
    @Deprecated
    protected boolean checkMana(Player player, saturn.elementPlugin.managers.ManaManager mana, int cost) {
     ...
     */
    protected boolean isValidTarget(Player player, org.bukkit.entity.LivingEntity target, saturn.elementPlugin.managers.TrustManager trust) {
