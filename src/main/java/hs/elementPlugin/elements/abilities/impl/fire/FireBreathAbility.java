    ...
    public boolean execute(ElementContext context) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                double cosThreshold = Math.cos(coneAngle);

                // Get perpendicular vectors for cone cross-sections
                ...
                for (double distance = startDistance; distance <= maxDistance; distance += distanceStep) {
                    ...
                    // Calculate cone radius based on distance
                    double radius = distance * Math.tan(coneAngle);

                    // Scale particle count with radius for visual consistency
